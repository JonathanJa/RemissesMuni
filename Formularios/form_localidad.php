...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <h1>Formulario Localidad</h1>
  <form action="form_loc_ingresar.php" method="POST" >
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Nombre:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" id="staticEmail" name="nombre_localidad" placeholder="Ingresar nombre">
    </div>
  </div>
