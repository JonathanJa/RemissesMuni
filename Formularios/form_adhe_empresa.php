...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <form action="form_adhe_emp_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Fecha de Inicio de Contrato:</label>
    <div class="col-sm-10">
      <input type="date"  class="form-control" id="staticEmail" name="adhemp_fechaInicioContratos" placeholder="Ingresar Fecha">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Fecha de Vencimiento de Contrato:</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputPassword" name="adhemp_fechaVntoContratos" placeholder="Ingresar apellidos">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Estado Actual:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword" name="adhemp_estadoActual" placeholder="Ingresar Estado Actual">
    </div>
  </div>
