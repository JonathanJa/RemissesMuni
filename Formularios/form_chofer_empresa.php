         ...
         <li class="nav-header">Configuración</li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="form_contacto.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Contactos</p>
                </a>
              </li>
...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
   ...
   <h1>Formulario Choferes</h1>
  <form action="form_choferes_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Número de Carnet:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" id="staticEmail" name="chof_nroCarnet" placeholder="Ingresar número">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Fecha de Vencimiento Carnet:</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" name="chof_fechaVencCarnet" id="vencCarnet"  placeholder="Ingresar fecha">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Certificado de Buena Conducta:</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputPassword" name="chof_nroCertifBuenaConducta" placeholder="Ingresar datos">
    </div>
  </div>
