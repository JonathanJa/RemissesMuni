...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <h1>Formulario de Seguros</h1>
  <form action="form_seg_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Nombres:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="seg_nombre" placeholder="Ingresar nombres">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Número de Seguro:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control"  name="seg_nroAseguradora" placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Cobertura:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control"  name="seg_cobertura" placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Patente:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control"  name="seg_patente" id="seg_patente"  placeholder="Ingresar Patente">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Fecha de Inicio Poliza:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="seg_fechaInicio" id="seg_fechaInicio" cols="30" rows="5" placeholder="Ingresar fecha">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Fecha Vencimiento de Poliza:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="fechaVntoPoliza " id="fechaVntoPoliza " cols="30" rows="5" placeholder="Ingresar fecha">
    </div>
  </div>
