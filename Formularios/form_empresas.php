...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <form action="form_emp_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Nombre de la Empresa:</label>
    <div class="col-sm-10">
      <input type="date"  class="form-control" id="staticEmail" name="emp_nombre" placeholder="Ingresar nombre">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">C.U.I.T:</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputPassword" name="emp_CUIT" placeholder="Ingresar datos">
    </div>
  </div>
