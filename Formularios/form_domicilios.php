...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <form action="form_dom_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Número de Manzana:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" id="staticEmail" name="dom_manzana" placeholder="Ingresar nombre">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Número de Casa:</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" name="dom_casa " placeholder="Ingresar Número de Casa">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Número de Piso:</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputPassword" name="dom_piso" placeholder="Ingresar Número de Piso">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Nombre de la Calle:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword" name="dom_calle" id="dom_calle"  placeholder="Ingresar nombre">
    </div>
  </div><div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Número de Departamento:</label>
    <div class="col-sm-10">
      <input type="number" class="form-control" id="inputPassword" name="dom_departamento" cols="30" rows="5" placeholder="Ingresar Número">
    </div>
  </div>
   ...
   <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Ingresar Altura:</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputPassword" name="dom_altura" id="dom_altura" cols="30" rows="5" placeholder="Ingresar Altura">
    </div>
  </div> 
