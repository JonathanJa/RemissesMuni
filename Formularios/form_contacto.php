...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <form action="form_contac_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Contactos:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" id="staticEmail"name="cont_contactos" placeholder="Ingresar Contacto">
    </div>
  </div>
