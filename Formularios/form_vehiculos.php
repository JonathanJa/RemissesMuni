...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <form action="form_vehic_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail">Nombre del Titular:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_nombreTitular" placeholder="Ingresar nombre titular">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >Nacionalidad:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_nacionalidad" placeholder="Ingresar Nacionalidad">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >Código:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_codigo" placeholder="Ingresar código">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail">Marca:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_marca" id="veh_marca"  placeholder="Ingresar Marca">
    </div>
  </div>
  <div class="mb-3 row" >
    <label for="staticEmail">Módelo:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_modelo" id="veh_modelo" placeholder="Ingresar fecha">
    </div>
  </div>
  <div class="mb-3 row" >
    <label for="staticEmail" >Chasis:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_chasis" id="veh_chasis" placeholder="Ingresar chasis">
    </div>
  </div>
  <div class="mb-3 row" >
    <label for="staticEmail" >Número de Motor:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_nroMotor" id="veh_nroMotor"  placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >Placa:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_nroPlaca" id="veh_nroPlaca"  placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >Título:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_nroTitulo" id="veh_nroTitulo"  placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >RTO:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="veh_nroRTO" id="veh_nroRTO" placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >Fecha de Vencimiento del RTO:</label>
    <div class="col-sm-10">
      <input type="date"  class="form-control" name="veh_nroVntoRTO" id="veh_nroVntoRTO" placeholder="Ingresar datos">
    </div>
  </div>
<div class="mb-3 row" >
    <label for="staticEmail" >Fecha de Vencimiento de Cedula:</label>
    <div class="col-sm-10">
      <input type="date" name="veh_cedulaVnto" id="veh_cedulaVnto" placeholder="Ingresar datos">
    </div>
  </div>
