...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <h1>Formulario Tipo Domicilio</h1>
  <form action="form_tipodom_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Descripción:</label>
    <div class="col-sm-10">
      <input type="text"  class="form-control" name="nombre_tipo" placeholder="Ingresar descripción">
    </div>
  </div>
