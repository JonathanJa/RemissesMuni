...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <h1>Formulario Adherentes</h1>
  <form action="form_adhe_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Descripción RTO:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" id="staticEmail" name="adhe_descripcionRTO" placeholder="Ingresar Fecha">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Habilitación:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword" name="adhe_habilitacion" placeholder="Ingresar apellidos">
    </div>
  </div>
