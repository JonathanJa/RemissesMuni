...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
   ...
   <h1>Formulario Choferes-Empresas</h1>
  <form action="form_chof_emp_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Fecha Contrato:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" id="staticEmail" name="chofemp_fechaContrato" placeholder="Ingresar Fecha Contrato">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Fecha Vencimiento Contrato:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword" name="chofemp_fechaVntoContrato" placeholder="Ingresar Fecha Vencimiento">
    </div>
  </div>
