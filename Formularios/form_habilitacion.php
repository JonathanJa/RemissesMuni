...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  <h1>Formulario Habilitación</h1>
  <form action="form_hab_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Fecha de Habilitación:</label>
    <div class="col-sm-10">
      <input type="date"  class="form-control" id="staticEmail" name="hab_fechaInicio" placeholder="Ingresar fecha">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Fecha de Vencimiento de la habiltación:</label>
    <div class="col-sm-10">
      <input type="date" class="form-control" id="inputPassword" name="hab_fechaVnto" placeholder="Ingresar fecha">
    </div>
  </div>
  <div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Número de Habilitación:</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword" name="hab_nroHabilitacion" placeholder="Ingresar Número">
    </div>
  </div>
<div class="mb-3 row">
    <label for="inputPassword" class="col-sm-2 col-form-label">Descripción:</label>
    <div class="col-sm-10">
      <input type="textarea" class="form-control" id="inputPassword" name="hab_descripcion" id="hab_descripcion"  placeholder="Ingresar descripción">
    </div>
  </div>
