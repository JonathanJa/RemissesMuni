...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <form action="form_pers_ingresar.php" method="POST" >
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Nombre:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" name="pers_nombres" placeholder="Ingresar nombres">
    </div>
  </div>
...
<div class="mb-3 row" >
    ...
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" name="pers_apellidos" placeholder="Ingresar apellidos">
    </div>
  </div>
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Número de Documento:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control" name="pers_nroDocumento" placeholder="Ingresar Documento">
    </div>
  </div>
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Fecha de Nacimiento:</label>
    <div class="col-sm-10">
      <input type="date"  class="form-control" name="pers_fechaNacimiento" id="fechaNacimiento"  placeholder="Ingresar fecha">
    </div>
  </div>

<select name="pers_estadoCivil" id="estadoCivil" class="form-select" aria-label="Default select example">
...
<div class="mb-3 row" >
    ...
    <div class="col-sm-10">
      <input type="date"  class="form-control" name="pers_fechaRegistro" id="pers_fechaRegistro" cols="30" rows="5" placeholder="Ingresar fecha">
    </div>
  </div>
