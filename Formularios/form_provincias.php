...
<div style="margin-left: 10%; margin-top: 10%; width: 800px;">
  ...
  <h1>Formulario de Provincia</h1>
  <form action="form_prov_ingresar.php" method="POST">
  <div class="mb-3 row" >
    <label for="staticEmail" class="col-sm-2 col-form-label">Nombre de la Provincia:</label>
    <div class="col-sm-10">
      <input type="textarea"  class="form-control"  name="nombre_provincia" placeholder="Ingresar nombres">
    </div>
  </div>
